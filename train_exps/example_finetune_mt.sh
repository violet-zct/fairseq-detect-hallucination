...
ROOT=/private/home/chuntinz/work/fairseq-hallucination/pretrain_scripts/container/xlmr.large
# path to the synthetic data created with make_synthetic_data_mt.sh
DATABIN=$1
# path to the save directory
SAVE=checkpoints/finetune_mt
...
SRC=zh  # subset name of source
TGT=en   # subset name of target

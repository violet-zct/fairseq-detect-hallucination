...
DATABIN=${datadir}/mask_0.0_0.3_random_0.0_0.3_insert_0.1_wholeword_1_iters_5/bin  #todo
# path to the save directory
SAVE=checkpoints/3_unsup_iter5_with_ref_upweight_pos_labels_mask_lm_0.5  #todo

...
DATABIN=${datadir}/semi_mask_0.0_0.2_random_0.1_0.25_insert_0.1_wholeword_1_iters_1/bin  #todo
# path to the save directory
SAVE=checkpoints/92_0.2_semi_with_ref_upweight_pos_labels_mask_lm_0.5  #todo
